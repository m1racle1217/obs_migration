...
class WebConsoleServerTests(unittest.TestCase):
    ...
    def test_static_page_polishes_browser_profiles_and_controls(self):
        ...
        self.assertIn('id="position-preset-paths"', html)
        self.assertIn('id="position-preset-prefixes"', html)
        self.assertIn('position-preset-paths-label', html)
        self.assertIn('position-preset-prefixes-label', html)
        self.assertIn("function parsePresetTextList", html)
        self.assertIn('const typedPaths = parsePresetTextList(document.getElementById("position-preset-paths").value)', html)
        self.assertIn('const typedPrefixes = parsePresetTextList(document.getElementById("position-preset-prefixes").value)', html)
        self.assertIn('document.getElementById("position-preset-paths").value = pathList.join("\\n")', html)
        self.assertIn('document.getElementById("position-preset-prefixes").value = prefixList.join("\\n")', html)
